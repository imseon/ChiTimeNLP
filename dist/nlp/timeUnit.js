 ...
 *Date:2017/11/1
 */
const timePoint_1 = __importDefault(require("./timePoint"));
...
class TimeUnit {
    ...
    constructor(expTime, isPreferFuture, timeBase) {
        ...
        this._tpOrigin = new timePoint_1.default(this.timeBase);
    ...
    _preferFuture(checkTimeIndex) {
        ...
        const tp = new timePoint_1.default(d);
    ...
    _preferFutureWeek(weekday) {
        ...
        // 准备增加的时间单位是被检查的时间的上一级，将上一级时间+1
        this.timeBase = util_1.default.getDateAfterWeeks(d, 1, weekday);
    }
    /**
     * 年-规范化方法
     * <p>
    ...
    normSetHour() {
        ...
        if (match && match.length > 0) {
            if (this._tp.tunit[3] === -1) {
                ...
                this._tp.tunit[3] = enum_1.default.dayBreak;
            }
            /** 处理倾向于未来时间的情况   */
            this._preferFuture(3);
            this.isAllDayTime = false;
        ...
        if (match && match.length > 0) {
            if (this._tp.tunit[3] === -1) {
                ...
                this._tp.tunit[3] = enum_1.default.earlyMorning;
            }
            /** 处理倾向于未来时间的情况   */
            this._preferFuture(3);
            this.isAllDayTime = false;
        ...
        if (match && match.length > 0) {
            if (this._tp.tunit[3] === -1) {
                ...
                this._tp.tunit[3] = enum_1.default.morning;
            }
            /** 处理倾向于未来时间的情况   */
            this._preferFuture(3);
            this.isAllDayTime = false;
        ...
        if (match && match.length > 0) {
            ...
            if (this._tp.tunit[3] === -1) {
                ...
                this._tp.tunit[3] = enum_1.default.noon;
            }
        }
        ...
        if (match && match.length > 0) {
            ...
            if (this._tp.tunit[3] === -1) {
                ...
                this._tp.tunit[3] = enum_1.default.afternoon;
            }
            /** 处理倾向于未来时间的情况   */
            this._preferFuture(3);
            this.isAllDayTime = false;
        ...
        if (match && match.length > 0) {
            if (this._tp.tunit[3] >= 1 && this._tp.tunit[3] <= 11) {
                ...
                this._tp.tunit[3] = enum_1.default.night;
            }
            /** 处理倾向于未来时间的情况   */
            this._preferFuture(3);
            this.isAllDayTime = false;
    ...
    normSetMinute() {
        ...
        if (match && match.length > 0) {
            ...
            const tmp = util_1.default.reverseStr(this.timeExpression);
    ...
    normSetSecond() {
        ...
        if (match && match.length > 0) {
            ...
            match = tmp.match(rule);
            if (match && match.length > 0) {
                const s = util_1.default.reverseStr(match[0]);
    ...
    normSetBaseRelated() {
        ...
        if (match && match.length > 0) {
            ...
            d = util_1.default.getDateAfterDays(d, -day);
        }
        ...
        if (match && match.length > 0) {
            flag[1] = true;
            day = parseInt(match[0], 10);
            d = util_1.default.getDateAfterMonths(d, -day);
        }
    ...
    normSetCurRelated() {
        ...
        if (match && match.length > 0) {
            flag[0] = true;
            d = util_1.default.getDateAfterYears(d, -2);
        }
        rule = new RegExp('去年', 'g');
        match = this.timeExpression.match(rule);
        if (match && match.length > 0) {
            flag[0] = true;
            d = util_1.default.getDateAfterYears(d, -1);
        }
        rule = new RegExp('今年', 'g');
        match = this.timeExpression.match(rule);
        if (match && match.length > 0) {
            flag[0] = true;
            d = util_1.default.getDateAfterYears(d, 0);
        }
        ...
        if (match && match.length > 0) {
            flag[1] = true;
            d = util_1.default.getDateAfterMonths(d, -1);
        }
        rule = new RegExp('(本|这个)月', 'g');
        match = this.timeExpression.match(rule);
        if (match && match.length > 0) {
            flag[1] = true;
            d = util_1.default.getDateAfterMonths(d, 0);
        }
        ...
        if (match && match.length > 0) {
            flag[2] = true;
            d = util_1.default.getDateAfterDays(d, -3);
        }
        rule = new RegExp('大前天', 'g');
        match = this.timeExpression.match(rule);
        if (match && match.length > 0) {
        ...
        if (match && match.length > 0) {
            flag[2] = true;
            d = util_1.default.getDateAfterDays(d, -1);
        }
        rule = new RegExp('今(?!年)', 'g');
        match = this.timeExpression.match(rule);
        if (match && match.length > 0) {
            flag[2] = true;
            d = util_1.default.getDateAfterDays(d, 0);
        }
        ...
        if (match && match.length > 0) {
            flag[2] = true;
            d = util_1.default.getDateAfterDays(d, -2);
        }
        ...
        if (match && match.length > 0) {
            flag[2] = true;
            day = parseInt(match[0], 10);
            d = util_1.default.getDateAfterWeeks(d, -2, day);
        }
        ...
        if (match && match.length > 0) {
            flag[2] = true;
            day = parseInt(match[0], 10);
            d = util_1.default.getDateAfterWeeks(d, -1, day);
        }
        ...
        if (match && match.length > 0) {
            ...
            d = util_1.default.getDateAfterWeeks(d, addW, day);
        }
        if (flag[0] || flag[1] || flag[2]) {
            this._tp.tunit[0] = d.getFullYear();
        }
    ...
    timeNormalization() {
        ...
        for (let i = 1; i < 6; i++) {
            if (this._tp.tunit[i] !== -1) {
                _resultTmp[i] = util_1.default.zeroPad(2, this._tp.tunit[i]);
            }
            else {
                _resultTmp[i] = '00';
            }
